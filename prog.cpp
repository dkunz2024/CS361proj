...
int main(){
    ...
    cout << "\nThis is the UI used for CS361 Assignment #4" << endl;
    ...
    while(true){
        ...
        cout << "\n1) Find recycling locations near me given a zip code or address" << endl;
        cout << "2) What can be recycled? Recycling information" << endl;
...
void recycling_information(){
    ...
    cout << "\nPaper:" << endl;
    cout << "> Office paper, newspapers, junk mail and greeting cards, magazines" << endl;
    cout << "> Paperback books, phone books, and notebooks (metal binding is accepted!)" << endl;
